...
import (
	...
	stdlib "github.com/Waryway/Wayframe/pkg/server/stdlib"
)
...
func main() {
	...
	// Create server using pkg/server stdlib adapter
	srv := stdlib.New(server.Config{
	...
	srv.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
		...
		_, _ = fmt.Fprintf(w, "Welcome to Wayframe with Standard Library!\n")
